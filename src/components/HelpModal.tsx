            ...
            <div className="space-y-6" dir={isRTL ? 'rtl' : 'ltr'}>
              ...
              <div className="bg-zinc-800/50 p-6 rounded-xl border border-zinc-700">
                ...
                <ol className={`list-decimal list-inside space-y-4 text-zinc-300 ${isRTL ? 'font-arabic' : ''}`}>
                  {language === 'en' ? (
                    <>
                      <li>Go to <strong>Tex 2 Img</strong>, upload the image that caused this error.</li>
                      <li>Select the <strong>seedream-5-pro</strong> model (do anything to the image, even change the color of clothes or add a brooch, just do anything so you can save it).</li>
                      <li>Save it as <strong>jpeg</strong>, then go back to <strong>Video AI</strong> and upload the new image instead.</li>
                    </>
                  ) : (
                    <>
                      <li>اذهب إلى خانة <strong>Tex 2 Img</strong> وارفع الصورة التي سببت ظهور الخطأ.</li>
                      <li>اختر موديل <strong>seedream-5-pro</strong> (اعمل اي شي على الصوره حتى لو تغير لون ملابس تضع بروش المهم اي شي لتستطيع تحفظها).</li>
                      <li>احفظها بصيغة <strong>jpeg</strong>، ثم عد إلى خانة <strong>Video AI</strong> وارفع الصورة الجديدة بدلاً من القديمة.</li>
                    </>
                  )}
                </ol>
              </div>
