...
const App: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen flex flex-col bg-[#050505] text-white`}>
      ...
      <main className={(isCheckout ? "flex-1 w-full px-6 py-12 flex items-center justify-center" : "flex-1 max-w-[1400px] mx-auto w-full px-6 pt-12 pb-32") + " relative"}>
      ...
      {isTermsOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 animate-in fade-in duration-300">
           ...
           <div className="relative glass-effect w-full max-w-2xl p-8 rounded-[40px] border border-white/10 shadow-2xl space-y-8 overflow-hidden animate-in zoom-in-95 duration-500 max-h-[80vh] overflow-y-auto custom-scrollbar">
              ...
              <div className="space-y-6 text-zinc-300">
                <p className="text-sm leading-relaxed">
                  Welcome to Analyzer A. By using our AI services, you agree to the following terms regarding usage, credits, and content.
                </p>
               ...
               <div className="space-y-4">
                  ...
                  <div className="bg-white/5 p-4 rounded-2xl border border-white/5">
                    <h3 className="text-white font-bold mb-3 text-lg flex items-center gap-2">
                        <span className="p-1 bg-blue-500/20 rounded text-blue-400">📝</span> Input Fields & Content
                    </h3>
                    <ul className="space-y-3 text-sm text-zinc-400">
                        <li className="flex gap-3">
                            <span className="font-bold text-white min-w-[80px]">Text Prompt:</span>
                            <span>Describe your desired video scene in detail. The AI uses this to understand the action, lighting, and mood.</span>
                        </li>
                        <li className="flex gap-3">
                  ...
                  <div className="bg-white/5 p-4 rounded-2xl border border-white/5">
                    <h3 className="text-white font-bold mb-3 text-lg flex items-center gap-2">
                        <span className="p-1 bg-yellow-500/20 rounded text-yellow-400">🪙</span> Credits & Points System
                    </h3>
                    <div className="space-y-2 text-sm text-zinc-400">
                        ...
                        <p className="text-xs text-zinc-500 mt-2">* Credits are deducted upon successful request submission.</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white/5 p-4 rounded-2xl border border-white/5">
                    <h3 className="text-white font-bold mb-1">Disclaimer & Accuracy</h3>
                    <div className="text-sm text-zinc-400 leading-relaxed">
                        Please be aware that AI-generated results are probabilistic and may vary. While we strive for high accuracy, there is a possibility of:
                        <ul className="list-disc pl-5 mt-2 space-y-1 text-xs text-zinc-500">
                            <li>Non-matching facial features or artifacts.</li>
                            <li>Color discrepancies or unexpected textures.</li>
                            <li>Occasional generation failures.</li>
                        </ul>
                        <span className="block mt-2">Credits are consumed upon generation attempt. No refunds are provided for generations that do not meet subjective expectations due to inherent AI limitations.</span>
                    </div>
                  </div>
