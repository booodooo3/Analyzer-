            ...
            <div className="mt-4 pt-4 border-t border-white/10">
                ...
                <div className="grid grid-cols-2 gap-2">
                    {[
                        ...
                        { label: 'Look Forward', prompt: 'Modify the face in the image to look directly straight ahead at the camera, highly detailed, realistic, 4k' },
                        { label: 'Bulging Eyes', prompt: 'Modify the face in the image to have naturally wide open eyes in shock, realistic human photography, 85mm portrait, photorealistic, not 3D, highly detailed, realistic, 4k' },
                        { label: 'Kiss', prompt: 'Modify the face in the image to blow a kiss with puckered lips and showing a peace sign with fingers, photorealistic photography, highly detailed, realistic, 4k' },
                        { label: 'Slight Smile', prompt: 'Modify the face in the image to have a gentle, slight smile, highly detailed, realistic, 4k' },
                        { label: 'Laugh', prompt: 'Modify the face in the image to be laughing joyfully with an open mouth, highly detailed, realistic, 4k' },
                        { label: 'Angry', prompt: 'Modify the face in the image to have an angry, furious expression with furrowed brows, highly detailed, realistic, 4k' },
