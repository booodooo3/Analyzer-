...
export default async (req, context) => {
    ...
    if (req.method === "POST") {
        try {
            ...
            const { image, image2, description, duration, cameraEffect, aiFilter, model, aspectRatio, audioFile, videoInput, characterOrientation, video_path, resolution, seed } = await req.json();
