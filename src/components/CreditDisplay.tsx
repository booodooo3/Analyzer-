        ...
        {onTogglePlus && (
          <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col items-center">
                ...
                className={`flex items-center gap-2 px-3 py-1.5 rounded-lg border transition-all duration-300 ${
                    !isPlusMode 
                    ? 'bg-gradient-to-r from-amber-700 to-amber-900 border-amber-600 text-white shadow-[0_0_15px_rgba(217,119,6,0.5)]' 
                    : 'bg-zinc-800/50 border-zinc-700 text-zinc-400 hover:border-zinc-500 hover:text-zinc-200'
                }`}
                title={!isPlusMode ? "Single Mode Active: 1 Image" : "Switch to Single Mode"}
                >
                <span className={`text-xs font-bold uppercase tracking-wider ${!isPlusMode ? 'text-white' : ''}`}>
                    ONE
                </span>
              ...
              {onOpenVideoAI && (
                <div className="flex flex-col items-center ml-2">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-1.5 rounded-lg border border-zinc-700 bg-black text-white shadow-[0_0_10px_rgba(255,255,255,0.1)] hover:border-zinc-500 transition-all duration-300"
                    title="Convert Image to Video (Cost: 4 Credits)"
                  >
                    <span className="text-xs font-bold uppercase tracking-wider">
                      video Ai
                    </span>
