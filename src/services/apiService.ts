...
export const performVirtualTryOn = async (person: ImageData, cloth: ImageData, type: GarmentType, token: string, garmentDescription?: string, isPlusMode: boolean = false, isMakeoverMode: boolean = false) => {
  try {
