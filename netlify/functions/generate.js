...
export default async (req, context) => {
  ...
  try {
    ...
    let promptText = `Part 1: Reference Person (First Image). Part 2: Target Garment (Second Image). Part 3: A photo of a person wearing ${desc}. Preserve the original person's face and identity with 100% accuracy, perform the swap only on the garment regions.`;
    ...
    if (effectivePlusMode) {
         ...
         const prompts = [
            { type: 'front', text: `Part 1: Reference Person (First Image). Part 2: Target Garment (Second Image). Part 3: Half-body portrait of a person wearing ${desc}. Preserve the original person's face and identity with 100% accuracy, perform the swap only on the garment regions. FRAMING: From the top of the head down to the mid-thighs only. The camera is CLOSE to the subject. DO NOT show the lower legs or feet. The bottom of the image MUST end at the thighs. This is a ZOOMED-IN view, significantly closer than a full body shot. High quality, realistic.` },
            { type: 'side', text: `Part 1: Reference Person (First Image). Part 2: Target Garment (Second Image). Part 3: Side profile view of a person wearing ${desc}. Preserve the original person's face and identity with 100% accuracy, perform the swap only on the garment regions. High quality, realistic.` },
            { type: 'full', text: `Part 1: Reference Person (First Image). Part 2: Target Garment (Second Image). Part 3: Full body, head-to-toe shot of a person wearing ${desc}. Preserve the original person's face and identity with 100% accuracy, perform the swap only on the garment regions. The full body must be visible from head to feet, including legs and shoes, not cropped. The person is wearing the garment shown in the second image. High quality, realistic.` }
         ];
